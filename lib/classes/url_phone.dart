        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ElevatedButton(onPressed:(){_launchURLApp('tel:' + widget.phonenumber);},
                  child: const Icon(Icons.call),
                ),
                ElevatedButton(onPressed:(){_launchURLApp('sms:' + widget.phonenumber);},
                  child: const Icon(Icons.message_outlined),
                ),
                ElevatedButton(onPressed: (){Clipboard.setData(ClipboardData(text: widget.phonenumber));}, child: Row(
                  children: const [
                    Text(
                      'Copy',
                      style: TextStyle(
